        ...
        if(key != 0xFF)
        {
           ...
           if(i == 8)
           {
               if(strcmp(message,user_pass) == 0)
                {
                  clcd_print("Yes, Password is",(0x80 + 0));
               ...
               else
                {
                   if(attempt > 0)
                   {
                       if(attempt == 5)
                       {
                       clcd_print("Incorrect pass 5",(0x80 + 0));
                       clcd_print(" Attempt Left  ",(0xC0 + 0));
                       }
                       if(attempt == 4)
                       {
                       clcd_print("Incorrect pass 4",(0x80 + 0));
                       clcd_print(" Attempt Left  ",(0xC0 + 0));
                       }
                       if(attempt == 3)
                       {
                       clcd_print("Incorrect pass 3",(0x80 + 0));
                       clcd_print(" Attempt Left  ",(0xC0 + 0));
                       }
                       if(attempt == 2)
                       {
                       clcd_print("Incorrect pass 2",(0x80 + 0));
                       clcd_print(" Attempt Left  ",(0xC0 + 0));
                       }
                       if(attempt == 1)
                       {
                       clcd_print("Incorrect pass 1",(0x80 + 0));
                       clcd_print(" Attempt Left  ",(0xC0 + 0));
                       }
                   ...
                   {
                     clcd_print("Attmpt Maximum",(0x80 + 0));
