...
void main(void)
{
    ...
    clcd_print(" Press Switch 1 ",(0x80 + 0));
    clcd_print("Srart Stop Watch",(0xC0 + 0));
    ...
    while (1)
    {
       ...
       if(sw1 && (view_flag == 0))
       {
           clcd_print("SW :   :  :  :  ",(0x80 + 0));
           clcd_print(cesec,(0x80 + 14));
           clcd_print(secA,(0x80 + 11));
           clcd_print(minA,(0x80 + 8));
           clcd_print(hourA,(0x80 + 5));

       }
       if(sw1 && sw2)
       {
           clcd_print(cesec,(0xC0 + 14));
           clcd_print(secA,(0xC0 + 11));
           clcd_print(minA,(0xC0 + 8));
           clcd_print(hourA,(0xC0 + 5));
           if(laps == 5)
           {
           clcd_copy(L0,hourA,minA,secA,cesec);
           clcd_print(L0,(0xC0 + 0));
           }
           if(laps == 4)
           {
           clcd_copy(L1,hourA,minA,secA,cesec);
           clcd_print(L1,(0xC0 + 0));
           }
           if(laps == 3)
           {
           clcd_copy(L2,hourA,minA,secA,cesec);
           clcd_print(L2,(0xC0 + 0));
           }
           if(laps == 2)
           {
           clcd_copy(L3,hourA,minA,secA,cesec);
           clcd_print(L3,(0xC0 + 0));
           }
           if(laps == 1)
           {
           clcd_copy(L4,hourA,minA,secA,cesec);
           clcd_print(L4,(0xC0 + 0));
           laps = 6;
           }
           sw2 = 0;
           laps--;
