...
# 1 "./digital_keypad_1.h" 1
# 31 "./digital_keypad_1.h"
...
void main(void)
{
    unsigned char key,key_copy = 0x3F;
    ...
    while (1)
    {
          ...
          if(key != 0x3F)
          {
           ...
           if(msg_flag)
          {
              clcd_print("Enter input Msg",(0x80 + 0));
              clcd_print("Pass Min 16 Char",(0xC0 + 0));
        ...
        if(scrol_flag)
        {
            if(key_copy == 0x3F)
            {
               ...
               message[0] = temp;
               clcd_print(message,(0xC0 + 0));
               for(unsigned int j = 2000;j--; );
            }
            else if(key_copy == 0x3D)
            {
        ...
        else if((key_copy == 0x3B) && (scrol_flag == 0))
        {
           clcd_print("Stop Scroll ->",(0x80 + 1));
        }
