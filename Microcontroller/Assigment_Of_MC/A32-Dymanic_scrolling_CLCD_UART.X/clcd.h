...
#define CLCD_CURSOR_BLINK clcd_write(0x0F, INST_MODE)// curson keeps blinking
#define CLCD_CURSOR_LINE2 clcd_write(0xC0, INST_MODE)   // move curson to scond line or second row
