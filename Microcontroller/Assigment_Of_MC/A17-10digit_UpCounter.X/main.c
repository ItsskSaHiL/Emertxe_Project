 ...
 * Name : Sk Sahil
 * File:   main.c
 * Assigment : A17 - Implement a 10 digit Up counter
 * Date : 20/09/2022
 * Discription : 
 *  Problem Statement:
        Implement a 10 digit up counter on CLCD.
...
void main(void)
{
    ...
    while (1)
    {
		if (wait-- <= 0)
		{
            ...
            if((str[0] == '9') && (str[1] == '9') && (str[2] == '9') && (str[3] == '9') && (str[4] == '9') && (str[5] == '9') && (str[6] == '9') && (str[7] == '9') && (str[8] == '9') && (str[9] == '9'))
  			{
                str[0] = '9';
                str[1] = '9';
                str[2] = '9';
